class VariantQuickViewSelects extends HTMLElement {
    ...
    updateMasterId() {
        ...
        const productForms = document.querySelector(`#product-quick-view-form-${this.dataset.product}`);
        productForms.querySelector('[name="properties[UPC]"]').value = this.currentVariant.barcode;
    }
                ...
                if(inventoryQuantity > 0) {
                    ...
                    if(this.hotStock){
                        ...
                        if(0 < inventoryQuantity && inventoryQuantity <= maxStock){
                            ...
                            this.hotStock.innerHTML = "Hurry up! only a few left";
